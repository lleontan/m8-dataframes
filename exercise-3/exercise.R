...
salaries.2014<-runif(employees,0.1,100000)

# Create a vector of 2015 salaries that are typically higher than the 2014 salaires (use runif again)
salaries.2015<-runif(employees,5,1000000)

# Create a data.frame 'salaries' by combining the vectors you just made
salaries<-data.frame("name"=runif(0:1000),"s2014"=salaries.2014,"s2015"=salaries.2015)

# Create a column 'raise' that stores the size of the raise between 2014 and 2015
salaries$raise<-salaries[["s2014"]]-salaries[["s2015"]]
...
print(salaries[57,]$s2015)

# How many employees got a raise?
print(length(which(salaries$got.raise ==TRUE)))
#length(salaries[salaries$got.raise==True,])#THIS WILL ALSO WORK
#THIS WILL ALSO WORK



# What was the value of the highest raise?
biggest.raise<-max(salaries$raise,na.rm=FALSE)
